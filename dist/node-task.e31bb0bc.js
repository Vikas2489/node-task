...
console.log(_lodash.default.chunk(['a', 'b', 'c', 'd'], 2));
console.log(_lodash.default.compact([0, 1, false, 2, '', 3]));
var array = [1];

var other = _lodash.default.concat(array, 2, [3], [[4]]);

console.log(other);
console.log(_lodash.default.difference([2, 1], [2, 3]));
console.log(_lodash.default.indexOf([1, 2, 1, 2], 2));
console.log(_lodash.default.countBy(['one', 'two', 'three'], 'length'));
console.log(_lodash.default.findLast([1, 2, 3, 4], function (n) {
  return n % 2 == 1;
}));
console.log(_lodash.default.includes([1, 2, 3], 1));

function square(n) {
  return n * n;
}

console.log(_lodash.default.map([4, 8], square));
console.log(_lodash.default.some([null, 0, 'yes', false], Boolean));
...
//# sourceMappingURL=/node-task.e31bb0bc.js.map